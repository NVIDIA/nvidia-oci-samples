...
> **Note**: This workshop uses **1 node** with Text RAG + Shared LLM AIQ to minimize GPU requirements. For Full RAG + Full AIQ (2 nodes) and other options, see the [AIQ Blueprint on OKE Guide](README.md).
...
- [AIQ Blueprint on OKE Guide](README.md) — Full deployment options, 2-node setup, Full RAG + Full AIQ

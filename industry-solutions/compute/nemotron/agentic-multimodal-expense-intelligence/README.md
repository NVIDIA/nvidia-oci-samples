...
```bash
cd nvidia-oci-samples/industry-solutions/compute/nemotron/agentic-multimodal-expense-intelligence
...
```powershell
cd .\nvidia-oci-samples\industry-solutions\compute\nemotron\agentic-multimodal-expense-intelligence
npm run generate:receipts
npm test
npm run dev
```
...
git add industry-solutions/compute/nemotron/agentic-multimodal-expense-intelligence README.md

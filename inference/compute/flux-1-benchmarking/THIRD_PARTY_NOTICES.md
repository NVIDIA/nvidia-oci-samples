...
This directory contains NVIDIA-authored Apache-2.0 benchmark code and limited adaptations of the projects identified below. It is intended to be distributed as `inference/compute/flux-1-benchmarking` within [`NVIDIA/nvidia-oci-samples`](https://github.com/NVIDIA/nvidia-oci-samples), under that repository's top-level license. It does not redistribute model checkpoints, compiled inference engines, Python environments, or container images.

...
- [NIM on OKE Workshop](workshop.md) — hands-on workshop version
...
Use `instance_pools.json` and `placement_config.json` as in the [RAG Blueprint Appendix](../../../agentic/oke/rag/README.md#appendix-cli-deployment) (same structure: instance configuration OCID, size, availability domain, subnet).
